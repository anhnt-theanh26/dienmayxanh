...
Route::prefix('/')->as('')->group(function () {
    ...
    // product
    Route::get('{slug}-p{id}.html', [ClientProductDetailController::class, 'show'])->where(['slug'=> '[\w-]+', 'id'=>'\d+'])->name('product.show');
    Route::get('{slug}-p{id}-review.html', [ClientProductDetailController::class, 'review'])->where(['slug'=> '[\w-]+', 'id'=>'\d+'])->name('product.review');
    ...
    // category
    Route::get('/category.html', [ClientCategoryController::class, 'index'])->name('category.index');
    Route::get('/{slug}-parent.html', [ClientCategoryController::class, 'parent'])->where(['slug'=> '[\w-]+'])->name('category.parent');
    Route::get('/{slug}-category.html', [ClientCategoryController::class, 'show'])->where(['slug'=> '[\w-]+'])->name('category.show');


    // login
    Route::get('/login.html', [ClientLoginController::class, 'index'])->name('login.form');
    Route::post('/login.html', [ClientLoginController::class, 'login'])->name('login.submit');

    // register
    Route::get('/register.html', [ClientLoginController::class, 'create'])->name('register.form');
    Route::post('/register.html', [ClientLoginController::class, 'register'])->name('register.submit');
    
    // logout
    Route::get('/logout.html', [ClientLoginController::class, 'logout'])->name('logout');

    // cart
    Route::get('/cart.html', [ClientCartController::class, 'index'])->name('cart.index');
    Route::get('/destroy-cart.html', [ClientCartController::class, 'destroy'])->name('cart.destroy');
    ...
    // bill 
    Route::get('bill.html', [ClientBillController::class, 'index'])->name('bill.index');
    Route::prefix('bill')->as('bill.')->group(function () {
    ...
    // profile
    Route::get('profile.html', [ClientUserController::class, 'index'])->middleware(['auth'])->name('profile.index');
    Route::prefix('profile')->as('profile.')->group(function () {
    ...
    // post 
    Route::get('{slug}-a{id}.html', [ClientPostController::class, 'show'])->where(['slug'=> '[\w-]+', 'id'=>'\d+'])->name('post.show');
    
    Route::get('{slug}-p-a.html', [ClientPostController::class, 'index'])->where(['slug'=> '[\w-]+'])->name('post.index');
    Route::get('{slug}-p-c.html', [ClientPostController::class, 'category'])->where(['slug'=> '[\w-]+'])->name('post.category');
...
// email verify 
// https://allxone.vn/email-verification-with-laravel/
