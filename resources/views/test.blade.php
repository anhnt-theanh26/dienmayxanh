...
@section('css')
    ...
    <link rel="stylesheet"
        href="{{ asset('/administrator/assets/vendor/libs/datatables-rowgroup-bs5/rowgroup.bootstrap5.css') }}" />
    <link rel="stylesheet"
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-datatable table-responsive">
            <table class="dt-multilingual table" id="search">
                <thead>
                    <tr>
                        <th>id</th>
                        <th>Name</th>
...
@section('js')
    ...
    <script src="{{ asset('/administrator/assets/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js') }}"></script>
    <script src="{{ asset('/administrator/assets/js/tables-datatables-basic.js') }}"></script>
    <script>
