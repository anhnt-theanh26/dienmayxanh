                ...
                <li class="drop-down" style="border: none">
                    ...
                    @if (!empty($categoryparents) && $categoryparents !== null)
                        <div class="mega-menu fadeIn animated rounded-1">
                            ...
                            @foreach ($categoryparents as $categoryparent)
                                <div class="mm-6column submenu" style="margin-left: -20px; {{ $loop->first ? 'display: block;' : '' }}">
                                    <div class="row mx-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3 m-0 p-0">
                    <input type="text" class="form-control" id="detailAddress" placeholder="Chi tiết chỗ ở..."
                ...
                @foreach ($menufirst?->take(9) as $menuitem)
                    <li class="nav-item">
                        <a class="nav-link" style="text-transform:lowercase; color: var(--main-color);"
                            aria-current="page" href="{{ route('category.show', [$menuitem->link]) }}">{{ $menuitem?->name }}</a>
                    </li>
                @endforeach
            </ul>
        </div>
    ...
    $(document).ready(function() {
        ...
        function renderSuggestions(filteredData) {
            ...
            filteredData.forEach(item => {
                const itemUrl = `{{ route('product.show', ['slug' => ':slug', 'id' => ':id']) }}`
