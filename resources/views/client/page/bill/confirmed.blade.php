                ...
                <div class="d-flex align-items-center justify-content-between">
                    @if ($bill->status_cancel == 'not_requested')
                        <div class="canceled" id="canceled">
                            <div class="modal fade" id="confirmed" aria-hidden="true" aria-labelledby="confirmedLabel"
                                tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="confirmedLabel"> Yêu cầu hủy đơn hàng </h1>
                            ...
                            <button class="btn btn-warning text-white" data-bs-target="#confirmed" data-bs-toggle="modal">
