                    ...
                    <div class="user d-flex py-2">
                        <div class="">
                            <img width="30" height="30" class="object-fit-cover rounded-pill"
                                src="https://down-vn.img.susercontent.com/file/de951f94beea801b4efc8af9a903c8ef_tn"
                                alt="">
                        </div>
                        <div class="px-5">
                                        ...
                                        <form action="" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                <input type="date" class="form-control" id="birthdate"
                                                    value="{{ Auth::check() ? Auth::user()->birthdate : '' }}"
                                                    name="birthdate" placeholder="Ngày sinh...">
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <input type="file" class="form-control" id="image"name="image"
                                                    value="{{ Auth::check() ? Auth::user()->image : '' }}"
                                    ...
                                    <div class="p-5">
                                        <div class="mb-3">
                                            <div class="form-password-toggle">
                                                <label class="form-label" for="basic-default-password12">Old
                                                    Password</label>
                                        ...
                                        <div class="mb-3">
                                            <div class="form-password-toggle">
                                                <label class="form-label" for="basic-default-password12">New
                                                    Password</label>
                                                <div class="input-group">
                                                    <input type="password" class="form-control"
                                                        id="basic-default-password12" value=""
