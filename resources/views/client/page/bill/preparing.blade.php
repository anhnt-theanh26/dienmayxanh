@php
    $preparing = $bills->filter(function ($bill) {
                ...
                <div class="d-flex align-items-center justify-content-between">
                    @if ($bill->status_cancel == 'not_requested')
                        <div class="canceled" id="canceled">
                            <div class="modal fade" id="preparing" aria-hidden="true" aria-labelledby="preparingLabel"
                                tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="preparingLabel"> Yêu cầu hủy đơn hàng </h1>
                            ...
                            <button class="btn btn-warning text-white" data-bs-target="#preparing" data-bs-toggle="modal">
