        ...
        <div class="bg-white rounded-3">
            <div class="container">
                ...
                <div class="pt-3 row post-layout">
                    <div class="col-xxl-7 col-lg-7 col-sm-12 col-xs-12 col-12 post-main">
                    ...
                    <div class="col-xxl-5 col-lg-5 col-sm-12 col-xs-12 col-12 px-2 post-sidebar"
                        style="height: fit-content; background: pink;">
...
@section('js')
    ...
    {{-- seotoolhead --}}
    {{-- https://github.com/artesaos/seotools?tab=readme-ov-file#lumen --}}
@endsection
