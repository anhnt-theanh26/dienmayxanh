...
<section>
    <div class="container">
        <h4 class="fw-bold py-4">Gợi ý cho bạn</h4>
        <div class="bg-white rounded-4 p-2">
            <div class="row">
                <div class="col-2 my-2">
                    <a href="/OwlCarousel/dienmayxanh/chi-tiet-san-pham.html" class="text-decoration-none text-black">
                        <div class="p-3 m-2 border rounded-2" style="min-height: 450px; max-height: 450px;">
                            <p class="bg-secondary-subtle rounded-1 px-1" style="font-size: 12px; width: fit-content;">
                                Trả chậm 0%</p>
                            ...
                            <div class="">
                                ...
                                <p class="m-0 p-0">
                                    <span class="card-title m-0 p-0 text-decoration-line-through"
                                        style="font-size: 14px;">49.990.000₫</span><span class="text-danger">-31%</span>
                                </p>
                ...
                <div class="col-2 my-2">
                    <a href="/OwlCarousel/dienmayxanh/chi-tiet-san-pham.html" class="text-decoration-none text-black">
                        <div class="p-3 m-2 border rounded-2" style="min-height: 450px; max-height: 450px;">
                            ...
                            <div class="">
                                <p class="card-text m-0 p-0"> LG Inverter 666 lít InstaView LFB66BLMI</p>
                                <p class="text-warning px-1 m-0 p-0 my-2" style="font-size: 12px; width: fit-content;">
                                    Online giá rẻ quá</p>
                                <p class="card-title m-0 p-0 fw-bold text-danger" style="font-size: 18px;">
                                    34.490.000₫</p>
                                <p class="m-0 p-0">
