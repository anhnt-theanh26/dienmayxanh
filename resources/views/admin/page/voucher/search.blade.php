        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    @if ($status == 'index')
                        <a class="dropdown-item" href="{{ route('admin.attribute.edit', ['id' => $item->id]) }}">
                            <i class="ti ti-pencil me-1"></i> Edit
                        </a>
                        <form action="{{ route('admin.attribute.delete', ['id' => $item->id]) }}" method="post">
                            @csrf
                            @method('delete')
                    ...
                    @else
                        <form action="{{ route('admin.attribute.restore', ['id' => $item->id]) }}" method="post">
                            @csrf
