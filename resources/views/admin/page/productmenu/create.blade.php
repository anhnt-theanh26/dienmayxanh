...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Product Menu /</span> Create</h4>
    <div class="card-body">
        @if ($errors->any())
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.productmenu.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('admin.productmenu.index') }}"
