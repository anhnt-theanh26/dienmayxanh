...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Location Menu /</span> List</h4>
    <div class="card-body">
    ...
    <div class="card">
        <h5 class="card-header">Location Menu</h5>

        <div class="d-flex justify-content-between card-header my-0 py-0">
            <p></p>
            <div class="">
                <a class="btn btn-success" href="{{ route('admin.locationmenu.create') }}"
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item"
                                            href="{{ route('admin.locationmenu.edit', ['id' => $item->id]) }}">
                                            <i class="ti ti-pencil me-1"></i> Edit
                                        </a>
                                        <form action="{{ route('admin.locationmenu.destroy', ['id' => $item->id]) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
