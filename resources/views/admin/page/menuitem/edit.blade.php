                                            ...
                                            <div class="card accordion-item">
                                                <h2 class="accordion-header" id="{{ $parent->id }}">
                                                    <button type="button" class="accordion-button collapsed"
                                                        ...
                                                        data-bs-target="#accordion{{ $parent->id }}" aria-expanded="false"
                                        ...
                                        <div class="card accordion-item">
                                            <h2 class="accordion-header" id="create">
                                                <button type="button" class="accordion-button collapsed"
                                                    ...
                                                    aria-expanded="false" aria-controls="accordioncreate">
                                                    Tự tạo đường dẫn
                                                </button>
                                            </h2>
                                            <div id="accordioncreate" class="accordion-collapse collapse"
                                                aria-labelledby="create" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                            ...
                                            @foreach ($menuitems as $menuitem)
                                                <li
                                                    ...
                                                    <span class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        {{-- <form
                                                            action="{{ route('admin.menuitem.destroy', ['id' => $menuitem->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <button onclick="return confirm('Xoa vi tri menu?')"
