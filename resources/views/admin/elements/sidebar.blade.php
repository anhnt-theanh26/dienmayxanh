<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if (Auth::user()->can('index category parent') || Auth::user()->can('create category parent'))
        ...
        @endif
        @if (Auth::user()->can('index category') || Auth::user()->can('create category'))
        ...
        @endif
        @if (Auth::user()->can('index post') || Auth::user()->can('create post'))
        ...
        @endif
        @if (Auth::user()->can('index attribute') || Auth::user()->can('create attribute'))
        ...
        @endif
        @if (Auth::user()->can('index product') || Auth::user()->can('create product'))
        ...
        @endif
        @if (Auth::user()->can('index user') || Auth::user()->can('create user'))
        ...
        @endif
        @if (Auth::user()->can('index image') || Auth::user()->can('create image'))
        ...
        @endif
        @if (Auth::user()->can('index voucher') || Auth::user()->can('create voucher'))
        ...
        @endif
        @if (Auth::user()->can('index bill') || Auth::user()->can('create bill'))
        ...
        @if (Auth::user()->can('index setting') || Auth::user()->can('create setting'))
        @endif
